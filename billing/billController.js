...
//                 db.query(
//                   `SELECT p.PRODUCT_ID, p.PRESENT_QUANTITY, p.MIN_QUANTITY, s.EmailID, p.USER_ID, p.SELLING_PRICE
//                    FROM PRODUCT p
...
//                       const SELLING_PRICE = nameresults[0].SELLING_PRICE;
...
//                           .status(400)
//                           .json({
//                             error: `Product ${item.PRODUCT_NAME} with ID ${PRODUCT_ID} has lesser quantity than ordered.`,
//                           });
...
//                         );
//                         db.query(
//                           `INSERT INTO BILL_DETAILS (BILL_ID, PRODUCT_ID, QUANTITY,SELLING_PRICE) VALUES (?, ?, ?,?)`,
//                           [BILL_ID, PRODUCT_ID, item.QUANTITY,SELLING_PRICE],
//                           (err, results) => {
//                             if (err) {
//                               reject(err);
//                             } else {
...
//                 INNER JOIN PRODUCT ON BILL_DETAILS.PRODUCT_ID = PRODUCT.PRODUCT_ID where BILLS.BILL_ID=?`,
//                 [BILL_ID],
//                 (err, results) => {
//                   if (err) {
...
//                 res
//                   .status(500)
//                   .json({ error: "Could not insert bill data. " + err });
//               });
//             });
//         }
//       }
...
//           if (
//             CUST_NAME !== currentCust ||
//             CUST_CONTACT !== currentContact ||
