...
exports.getOrders = (id, callback) => {
  db.query(
    `SELECT O.ORDER_ID, P.PRODUCT_ID, P.PRODUCT_NAME, S.NAME,O.DATE,O.DATE_RECEIVED, O.QUANTITY, O.STATUS, O.USER_ID
    FROM ORDERS AS O 
...
exports.updateOrders = (order_id,status, callback) => {
  db.query(
    `UPDATE ORDERS
    SET STATUS = ?
    WHERE ORDER_ID = ?;
